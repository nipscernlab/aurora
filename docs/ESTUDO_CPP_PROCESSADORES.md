...
> Nada aqui foi implementado ainda. O quadro vivo de execução do projeto continua sendo o §17 do
> [ESTUDO_COMPLETO_AURORA.md](ESTUDO_COMPLETO_AURORA.md); este arquivo é a fonte de verdade
> do tema C++ e é referenciado de lá.
>
