...
\newcolumntype{Z}{>{\raggedright\arraybackslash\footnotesize}X}
...
% ---- títulos compactos ----
\titleformat{\section}{\large\bfseries\color{auroraDeep}}{\thesection}{0.5em}{}
\titlespacing*{\section}{0pt}{6pt}{2pt}
\titleformat{\subsection}{\normalsize\bfseries\color{auroraInk}}{\thesubsection}{0.5em}{}
...
\input{secoes/S01-visao-geral}
\input{secoes/S02-soft-processor}
\input{secoes/S03-linguagem-cmm}
\input{secoes/S04-yanc-pipeline}
\input{secoes/S05-aurora-arquitetura}
\input{secoes/S06-edicao-projeto-arvore}
\input{secoes/S07-compilacao-simulacao}
\input{secoes/S08-visualizacao-ondas-rtl}
\input{secoes/S09-aurora-intelligence}
\input{secoes/S10-produtividade}
\input{secoes/S11-toolchain-bundle}
\input{secoes/S12-catalogo-terceiros}
\input{secoes/S13-build-distribuicao}
\input{secoes/S14-pipeline-ponta-a-ponta}
\input{secoes/S15-engenharia-evolucao}

\input{secoes/S16-glossario-referencias}
