...
\begin{nota}
A AURORA é distribuída sob licença MIT (\copyright{} 2024--presente NIPSCERN).
...
As fontes ficam em \path{assets/fonts/}. Inter e JetBrains Mono são versionadas
no repositório como \code{.woff2}; a fonte Norse \emph{não} é versionada porque
sua licença proíbe redistribuição --- é baixada da fonte original (dafont) pelo
\file{download-norse-font.js} no bootstrap e embutida no aplicativo construído
(o que a licença permite). Em caso de falha de download, o letreiro
\enquote{Dagr} (controle de versão) recai sobre a fonte da UI.
...
Norse (Joël Carrouché) & Livre para uso comercial e embutimento; redistribuição proibida & Letreiro \enquote{Dagr} do painel de controle de versão. Baixada no bootstrap (\file{download-norse-font.js}); não versionada. Licença em \file{assets/fonts/NORSE-LICENSE.txt}. \\
\end{longtable}
...
internamente pelo NIPSCERN e não sejam \enquote{terceiros}, eles chegam à AURORA
...
SIL OFL 1.1 & Inter; JetBrains Mono & Embutimento de fonte. \\
Licença própria (sem redistribuição) & Norse & Embutida no app; baixada no bootstrap, não versionada. \\
