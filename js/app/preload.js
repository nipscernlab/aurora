...
const fileOperations = {
  ...
  historicoPontoCriar: (meta) => ipcRenderer.invoke('historico:ponto-criar', meta),
  historicoPontoListar: () => ipcRenderer.invoke('historico:ponto-listar'),
  historicoPontoPrevia: (id) => ipcRenderer.invoke('historico:ponto-previa', id),
  historicoPontoVoltar: (id) => ipcRenderer.invoke('historico:ponto-voltar', id),
...
const projectOperations = {
  ...
  // A simulacao do PRISM gravou um .vcd com os sinais do monitor e pede para
  // abri-lo no visualizador de ondas, pelo mesmo caminho do botao Wave.
  // Callback com {vcdPath, modulo}.
  onOpenWave:           (cb) => ipcRenderer.on('aurora:open-wave', (_, data) => cb(data)),
 ...
 *  hover, definition, references, rename, quick fixes); diagnostics are pushed the other way
