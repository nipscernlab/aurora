...
## [6.21.0](https://github.com/nipscernlab/aurora/compare/v6.20.0...v6.21.0) (2026-09-26)


### Features

* **compilacao:** cppCompilation, o passo C++ irmao do cmmCompilation, e os dois passos no spec_factory ([c3019fd](https://github.com/nipscernlab/aurora/commit/c3019fd521e6dc34bebbb49893d8b5cbafa27259))
* **compilacao:** cpppp e cppcomp passam pelo portao de execucao ([1db2cb2](https://github.com/nipscernlab/aurora/commit/1db2cb2c645ba9a2ce3d2dd5efe203e5545e1bdc))
* **compilacao:** o front end e escolhido pela linguagem do fonte, e um processador C++ compila de ponta a ponta ([9c799a6](https://github.com/nipscernlab/aurora/commit/9c799a65be23a748eff4ecf188fc58999be5aad0))
* **compilacao:** os dois CommandSpec do front end C++, cpppp e cppcomp ([8901015](https://github.com/nipscernlab/aurora/commit/8901015a133fa1e07460f9b008b78a94798e9edb))
* **editor:** .cpp e fonte de processador na arvore, nos dialogos e na deteccao de tipo ([94cc3f3](https://github.com/nipscernlab/aurora/commit/94cc3f3576da18cd2049038cd09d278315d9ab94))
* **ia:** 'cpp' nos enums das ferramentas, cpp-pp e cpp nas flags protegidas, e os prompts dos CLIs em dia ([9aac16f](https://github.com/nipscernlab/aurora/commit/9aac16f29b22845fda6824335ec5783ae141d5ec))
* **interface:** o simbolo da linguagem vira C++ quando o fonte e .cpp, no botao, na aba do terminal e na arvore ([72fca5c](https://github.com/nipscernlab/aurora/commit/72fca5c8882299b7abcabb378ad8192e04cda89f))
* **prism:** os simbolos acompanham o HDL do yanc v5.5 ([0aaac8e](https://github.com/nipscernlab/aurora/commit/0aaac8e186dade87ce5093e3826571cc21f10103))
* **processador:** criar um processador em C++ pela API, com o fonte em pragmas e a linguagem no .spf ([e8355cc](https://github.com/nipscernlab/aurora/commit/e8355ccf4340e3f2957a90eb48f6a00f145275d9))
* **processador:** o Processor Hub escolhe a linguagem, e em C++ so pergunta nome e portas ([9328d64](https://github.com/nipscernlab/aurora/commit/9328d64a01334a0a05d1bbd38b03c6a841feb929))
* **regras:** o sapho_rules.json passa a descrever o ISA do yanc v5.5 ([78c41fd](https://github.com/nipscernlab/aurora/commit/78c41fd53189ba3d66e4d8cfeb4c3df404b7b2e1))
* **yanc:** a Aurora passa a usar o yanc v5.5 ([ba13cbc](https://github.com/nipscernlab/aurora/commit/ba13cbc1819384728c90bf73e5728e2fdef3acb4))


### Bug Fixes

* **api:** formatar um arquivo fechado volta a formatar, e achar arquivo pelo nome sai do aurora_api ([45675f9](https://github.com/nipscernlab/aurora/commit/45675f9d12bfa82c4fae01fd15f6a60beeb4abff))
* **arvore:** as mensagens de erro da visao de pastas deixam de dizer 'unknown:' antes do motivo ([d5e0fc9](https://github.com/nipscernlab/aurora/commit/d5e0fc9da873a89e6cca99214a338458f679d149))
* **ci:** o knip passa a analisar os .ts, sobre a arvore sem os .js gerados ([5b49d51](https://github.com/nipscernlab/aurora/commit/5b49d512256719f9e3a4514820cda34dba5c75a9))
* **ci:** o passo da referencia das ferramentas compila o TypeScript antes ([9287287](https://github.com/nipscernlab/aurora/commit/928728754ad3ad3dcacd13ead9cb4ceb1224c022))
* **compilacao:** o botao Verilator para no fim do programa sem escrever #TOAQUI no .cmm do usuario ([2f37e8b](https://github.com/nipscernlab/aurora/commit/2f37e8bac21639df9c1d97237cc6c306ade5b1ee))
* **conversor:** o requireTarde nasce antes do primeiro uso, e import longo quebra em linhas ([99ad2a9](https://github.com/nipscernlab/aurora/commit/99ad2a9b22c7cc26e9c09151ac32befed1cb137a))
* **conversor:** o requireTarde vai depois de um import de varias linhas ([77c55c3](https://github.com/nipscernlab/aurora/commit/77c55c352f7b3961eeb63465853509b85a3f8eb7))
* **editor:** o realce deixa de depender de qual painel abriu o arquivo primeiro ([c1a68f6](https://github.com/nipscernlab/aurora/commit/c1a68f6de2530ff8fd2193621360db48fd70162e))
* **globais:** o cast (window as T).X tambem conta na catraca ([4a1ccd2](https://github.com/nipscernlab/aurora/commit/4a1ccd201e1d3db52768e80aa9ade72143303306))
* **globais:** o cast com parenteses no tipo tambem conta na catraca ([1a64878](https://github.com/nipscernlab/aurora/commit/1a648788fcbe56c8752a42148716f84eed42bd4d))
* **historico:** os dois passos do C++ ganham nome, e a tabela inteira ganha teste ([b2c6a4b](https://github.com/nipscernlab/aurora/commit/b2c6a4bf4a83d44b5eb0087749d366302adf0a1d))
* **ia:** o bloco de regras das ferramentas para de existir quatro vezes, e para de mentir em tres pontos ([56cc8f4](https://github.com/nipscernlab/aurora/commit/56cc8f47356ca847b9743d8039ff9df08edc4b5a))
* **ia:** o escape dos chips de anexo e da fila passa a cobrir aspas ([9b3c8e4](https://github.com/nipscernlab/aurora/commit/9b3c8e434721f4a0ea88c7513d98426d68be4911))
* **processador:** o tempo simulado para de ter duas respostas, e a config passa a ser lida num lugar so ([784b21c](https://github.com/nipscernlab/aurora/commit/784b21c3c95d6f685dc0068be0f1540c813d388f))
* **processador:** renomear um processador C++ leva o .cpp e o pragma junto ([c8cbd4f](https://github.com/nipscernlab/aurora/commit/c8cbd4f2cf32d47b2d9c4e6f90cc6eef19850ab4))
* **processador:** renomear um processador leva o SystemVerilog junto ([68f89c4](https://github.com/nipscernlab/aurora/commit/68f89c4a1015ca74539c17a4a6f7c79114bef596))
* **relato:** o e-mail de relato passa a levar sistema e versoes, e o bug_report vira .ts ([691ddb1](https://github.com/nipscernlab/aurora/commit/691ddb187beaf29d9c45346eebc1f35e428f416b))
* **tipos:** main.js e hierarchy_parser saem da catraca ([57ffa6a](https://github.com/nipscernlab/aurora/commit/57ffa6a4470c8a48a008c173733b63b5b8bcdf5b))


### Refactor

* **api:** a analise de .asm sai do aurora_api, com a parte pura em compilation/analise_asm.ts ([cef2775](https://github.com/nipscernlab/aurora/commit/cef27755ef921778dfaa8b3110df86b873ca1521))
* **api:** as memorias do projeto saem do aurora_api para memorias_ns.ts ([0208ce1](https://github.com/nipscernlab/aurora/commit/0208ce1dc22a48f28f929933e643045dbf785b2d))
* **api:** editor.openFile e formatFile importam o ProjectStore; o aurora_api deixa de ler o projeto por window ([5b1ec1b](https://github.com/nipscernlab/aurora/commit/5b1ec1b62b062eb43718e3c0ceb30ad23103127a))
* **api:** o ciclo do projeto e o renomear saem do aurora_api para ciclo_do_projeto_ns.ts e renomear_projeto_ns.ts ([6a27c16](https://github.com/nipscernlab/aurora/commit/6a27c164fec46e73a7d5ba6ce0d17469aa430809))
* **api:** o editor ativo, o piscar das linhas e a varinha saem do aurora_api para editor_ativo.ts ([be5e9a0](https://github.com/nipscernlab/aurora/commit/be5e9a041f72286fa2400916a5ee8b7c6a8f9f19))
* **api:** o namespace rules sai do aurora_api para rules_ns.ts ([5bd788b](https://github.com/nipscernlab/aurora/commit/5bd788b8117ee127f5c7e21d1893510851f9ea00))
* **api:** o namespace wave sai do aurora_api para wave_ns.ts, com os layouts numa implementacao so ([59ea3f3](https://github.com/nipscernlab/aurora/commit/59ea3f34bd2337a77d75b1a0e55666f9f911951a))
* **api:** os arquivos do projeto saem do aurora_api para arquivos_ns.ts ([ca317e4](https://github.com/nipscernlab/aurora/commit/ca317e4ef0a559930c40cce763b7b7ed26d0f89f))
* **api:** os processadores do projeto saem do aurora_api para processadores_ns.ts ([85b7ea8](https://github.com/nipscernlab/aurora/commit/85b7ea8a7c83aea18d58c0b35223ee77e0ce6ba8))
* **api:** prism, examples e manual saem do aurora_api para modulos .ts proprios ([249a53e](https://github.com/nipscernlab/aurora/commit/249a53e932da5d95f4f1b0c717419d69c7fd55f7))
* **arvore:** a raiz das operacoes da visao de pastas vem do ProjectStore, nao de window ([ea29167](https://github.com/nipscernlab/aurora/commit/ea291677fa5bb77f1d6a2fc83504e30c10ffacff))
* **arvore:** git_decorations importa o ProjectStore em vez de ler window.currentProjectPath ([5c133aa](https://github.com/nipscernlab/aurora/commit/5c133aa84bef6fb95ef652603f39e0b6e4634641))
* **arvore:** o controlador de vistas vira .ts e carrega a camada de edicao, e some o unico ciclo de import ([f042558](https://github.com/nipscernlab/aurora/commit/f0425581b4991b00ed8fd7890eea7dc1480cff3d))
* **arvore:** o file_tree_manager vira .ts, sem o TreeViewState e sem o toggleHierarchyView ([93965db](https://github.com/nipscernlab/aurora/commit/93965db63485996a4c36593e7f2ce96c3b3e2214))
* **arvore:** o standard_tree_crud se divide em cinco modulos .ts ([51f253f](https://github.com/nipscernlab/aurora/commit/51f253f1db95c8e4d99556686b8799871aa52938))
* **arvore:** o standard_tree_crud vira .ts ([e0a760c](https://github.com/nipscernlab/aurora/commit/e0a760c2be8195ae0500bb919b9374965034bc3a))
* **arvore:** tree_history, fs_name_utils, tree_selection e spf_paths viram .ts ([593d8fe](https://github.com/nipscernlab/aurora/commit/593d8fe7d98d55fc9f1fa35f3257b1038b009e85))
* **compilacao:** a descoberta de processadores e a pre-compilacao saem do compilation_flow para precompilacao.ts ([ec5a334](https://github.com/nipscernlab/aurora/commit/ec5a334fafe6209d20ab265d3f4341f2844b0230))
* **compilacao:** a habilitacao dos botoes da barra sai do compilation_flow para botoes_da_barra.ts ([0e70477](https://github.com/nipscernlab/aurora/commit/0e70477658ca5362bd79413bccc0b373103b69eb))
* **compilacao:** o estado do cancelamento sai do compilation_flow para cancelamento.ts ([bc96de6](https://github.com/nipscernlab/aurora/commit/bc96de69ef98d690bf6bbcf61f56aeff38402d72))
* **compilacao:** o registro de execucoes sai do compilation_flow para registro_de_execucao.ts ([a1cfa89](https://github.com/nipscernlab/aurora/commit/a1cfa893aca35c641fd4290776cbb9f5cdf73fac))
* **compilacao:** os passos do processador perguntam ao resolvedor qual e o fonte ([6f752c7](https://github.com/nipscernlab/aurora/commit/6f752c7e9126f67d7010e09ab1d5d0de95cb02ae))
* **compilacao:** processor_compiler importa o cancelamento em vez de ler window ([177f463](https://github.com/nipscernlab/aurora/commit/177f463807cde16ff65a0b12e1d8da2725de7b4e))
* **compilacao:** um so lugar responde qual e o fonte de um processador e em que linguagem ([bff7016](https://github.com/nipscernlab/aurora/commit/bff7016d1e11dc7a2f281156558f6a943edee7ee))
* **historico:** run_history importa o ProjectStore em vez de ler window.currentProjectPath ([84f9982](https://github.com/nipscernlab/aurora/commit/84f9982dce31e99785ebd8887af099b08edc19f3))
* **ia:** a citacao do manual sai da classe, com as duas formas de resultado travadas ([aa5a831](https://github.com/nipscernlab/aurora/commit/aa5a831255b4f993675cf6afa0a6f9b15c897efa))
* **ia:** a regra de sandbox das referencias a arquivo sai da classe e ganha teste ([d227866](https://github.com/nipscernlab/aurora/commit/d227866794fa3fa635b93c107b7860c51c1e1611))
* **ia:** ai_metadata e provider_view viram .ts ([f0393b5](https://github.com/nipscernlab/aurora/commit/f0393b55bd967a10642df194e3cbb625d09aa6d7))
* **ia:** estado da conexao, link externo e caminho citado saem do ai_assistant_manager ([acd6150](https://github.com/nipscernlab/aurora/commit/acd6150d4c8ec6b9af01164891bde4a01c56262b))
* **ia:** o chat_attachments vira .ts ([6b50fa9](https://github.com/nipscernlab/aurora/commit/6b50fa9aadf7ba8c908541ac06efc102cbf04829))
* **ia:** o chat_render vira .ts ([6b1aedd](https://github.com/nipscernlab/aurora/commit/6b1aedde54d47a44f97aae7762b834553243c25b))
* **ia:** o contexto do turno e a abertura de referencia saem do ai_assistant_manager ([47601d3](https://github.com/nipscernlab/aurora/commit/47601d33848b5eaec6840204f88acc2af53d101c))
* **ia:** o desenho da fila e o aviso de assinatura saem do ai_assistant_manager ([6beecf9](https://github.com/nipscernlab/aurora/commit/6beecf9ee566e248dcc59a0c2ce71d1ecb376321))
* **ia:** o painel de IA le o projeto do ProjectStore, nao de window ([f88d13c](https://github.com/nipscernlab/aurora/commit/f88d13cc79fc1808094c713329d76923297cafb4))
* **ia:** o system_prompt vira .ts ([631329a](https://github.com/nipscernlab/aurora/commit/631329a072b29b27c6a4c194f063d46ca26e5608))
* **ia:** o texto dos chips de ferramenta sai da classe de 4119 linhas ([bcafea1](https://github.com/nipscernlab/aurora/commit/bcafea16f6a28161fbf880d3b623a781c45cdce2))
* **ia:** os anexos do composer saem do ai_assistant_manager para js/ai/anexos_do_chat.ts ([8d4e182](https://github.com/nipscernlab/aurora/commit/8d4e18235a6abf22e2d8a7f5895c664580b83e47))
* **nomes:** as regras de nome de arquivo param de existir em dois lugares ([ec7d8b4](https://github.com/nipscernlab/aurora/commit/ec7d8b41a4acae5466465b4ebc7cf7518b38187b))
* **processador:** o cabecalho de hardware passa a ser lido num lugar so, e enxerga C++ ([346420a](https://github.com/nipscernlab/aurora/commit/346420aa20868ac615fcf16c67a73248625563f6))
* **processador:** os numeros de um processador novo passam a morar num lugar so ([734a8c0](https://github.com/nipscernlab/aurora/commit/734a8c0b392d56715dbd1c3f6feedffe976ec228))
* **projeto:** fechar e excluir o projeto viram .ts, e ninguem mais le window.currentSpfPath ([1028fae](https://github.com/nipscernlab/aurora/commit/1028fae44c54e60da638145fbb6f6e4244be0849))
* **projeto:** o ProjectStore deixa de espelhar o .spf em window.currentSpfPath ([b2fb994](https://github.com/nipscernlab/aurora/commit/b2fb9945d17f74f7a4fef9f09562a4f1f7b8007a))
* **projeto:** o relatorio de arquivos faltando e a interface do projeto saem do project_manager ([076e373](https://github.com/nipscernlab/aurora/commit/076e3738fb936405ef4c3ff3ecc06db876e44a47))
* **projeto:** spec_factory e command_overrides importam o ProjectStore em vez de ler window ([e51000f](https://github.com/nipscernlab/aurora/commit/e51000fe2d7059ca8519fb82100fe9106a12886e))
* **regras:** o sync-sapho-rules vira .mts ([68c3877](https://github.com/nipscernlab/aurora/commit/68c3877d180c34373be40af5802f0b3d9c0b80c0))
* **spf:** o processo principal e o renderer param de ler o .spf com dois parsers ([8633c86](https://github.com/nipscernlab/aurora/commit/8633c8628176d6fd9e65a426d0e91dd2247529df))
* **terminal:** o error_locations vira .ts ([4085c87](https://github.com/nipscernlab/aurora/commit/4085c8760f209087423614b57c218559c24cb527))
* **terminal:** o link de arquivo relativo resolve contra a pasta do ProjectStore, nao a de window ([6944745](https://github.com/nipscernlab/aurora/commit/6944745753f478d41d4071d9706375526a7f314a))
* **terminal:** o progress_line vira .ts ([04e9bdf](https://github.com/nipscernlab/aurora/commit/04e9bdf4383045b13e8b6a37a9009067b021a58c))
* **terminal:** o shell do TCMD nasce na pasta que o ProjectStore diz, nao na de window ([d595475](https://github.com/nipscernlab/aurora/commit/d59547501a4983195c8ff90286fff22ef107dfb4))
* **terminal:** o shell do TCMD vira .ts ([2245bf8](https://github.com/nipscernlab/aurora/commit/2245bf8367775241692fff0c92c0db04be11943c))
* **terminal:** o terminal_module se divide em quatro modulos .ts ([d873c6e](https://github.com/nipscernlab/aurora/commit/d873c6eb5abeddd70d2d655f17b74e3dd887194c))
* **terminal:** o terminal_module vira .ts ([bcaed5c](https://github.com/nipscernlab/aurora/commit/bcaed5c427cf220b81f32392ab3cbfb5ff42dfe0))
* **terminal:** os links da saida saem do terminal_module para links_do_terminal.ts ([c5b29e3](https://github.com/nipscernlab/aurora/commit/c5b29e3ce809efbb32669eb4cee01bed41cfdb6f))
* **terminal:** problems_panel, terminal_excerpt e tab_orientation viram .ts; js/terminal fica sem .js ([5d9f314](https://github.com/nipscernlab/aurora/commit/5d9f314a03f515884b21907301f6f644def2b48c))
* **terminal:** terminal e aurora-terminal viram .ts, e sai o terminal.d.ts escrito a mao ([7090921](https://github.com/nipscernlab/aurora/commit/70909217a4e0dfe2c9b78f7fde79e7bf5e169249))
* **tipos:** a vista de pastas vira .ts em strict, pelo conversor, e le o projeto do ProjectStore ([d392177](https://github.com/nipscernlab/aurora/commit/d392177ed2f4d9c009524ec7b8680b185c4cff87))
* **tipos:** active_processor vira .ts em strict, e ganha o teste que nao tinha ([0dbe328](https://github.com/nipscernlab/aurora/commit/0dbe328638d2deaffc31fc3326b2fc8d4732f89f))
* **tipos:** ai/memory vira .ts em strict, pelo conversor ([4a44cc4](https://github.com/nipscernlab/aurora/commit/4a44cc4159016d8f0704a2a1c68369b8c58e6eee))
* **tipos:** bug_report vira .ts em strict ([cf46d04](https://github.com/nipscernlab/aurora/commit/cf46d041af130ebaff26346a972f590e5e832499))
* **tipos:** callbacks done(err, val), tipos que faltavam e typedefs incompletos saem da catraca ([669bdc4](https://github.com/nipscernlab/aurora/commit/669bdc40b8360e4b245225127754a3247bc46f23))
* **tipos:** citacoes vira .ts em strict ([59bc2e9](https://github.com/nipscernlab/aurora/commit/59bc2e97761d6a59d27da5acf5a99470a9275be2))
* **tipos:** cli_manifest vira .ts com os dados num .json ao lado, e o sync deixa de reescrever codigo por regex ([da67dc0](https://github.com/nipscernlab/aurora/commit/da67dc05c1a1bc402cde69a17284bf85e5a6c905))
* **tipos:** dialog_manager, help_link e status_updater viram .ts, e a conta de .d.ts a mao cai para um ([8b07ba2](https://github.com/nipscernlab/aurora/commit/8b07ba22a86dba74f376d18d4541c8e65866e74c))
* **tipos:** git_decorations vira .ts em strict, pelo conversor ([b5f41b2](https://github.com/nipscernlab/aurora/commit/b5f41b2478b704dbcc58bb71e8919c69ba29e84f))
* **tipos:** git, historico, as duas autenticacoes e tres scripts saem da catraca ([20aaeac](https://github.com/nipscernlab/aurora/commit/20aaeacb1dd868f4755d4c3b3179b511bd0a121e))
* **tipos:** github_forget vira .ts em strict ([a36afe1](https://github.com/nipscernlab/aurora/commit/a36afe1242a247319c20f46a1c6aa9f751305f9a))
* **tipos:** grammars do tree-sitter vira .ts em strict ([3cb8a84](https://github.com/nipscernlab/aurora/commit/3cb8a845765a052d195cd9b2e5efe7f271c0c3c7))
* **tipos:** inv_filter, material_icons e tree_view viram .ts em strict, pelo conversor ([1c7cbf0](https://github.com/nipscernlab/aurora/commit/1c7cbf01ac3f31446709e6620304941050effe98))
* **tipos:** ipc/git vira .ts em strict, pelo conversor ([ef416ee](https://github.com/nipscernlab/aurora/commit/ef416ee1706ca890a6bbd260927ce4575fa723db))
* **tipos:** o PRISM vira .ts em strict, e a catraca cai de 503 para 99 ([abdca40](https://github.com/nipscernlab/aurora/commit/abdca4034385bcaa0e046c41ee97d218cb34e04b))
* **tipos:** o project_manager vira .ts em strict, pelo conversor ([5fdfe59](https://github.com/nipscernlab/aurora/commit/5fdfe59b4637fbdb48432b111e2ecdff9260576d))
* **tipos:** o que sobrou do compilation_flow vira .ts em strict, pelo conversor ([c34ed3d](https://github.com/nipscernlab/aurora/commit/c34ed3dd876d62277058da3f205a35d3c696841e))
* **tipos:** o registro de componentes vira .ts em strict ([80aeb7b](https://github.com/nipscernlab/aurora/commit/80aeb7b3d9acd18741540db8071b9833e58017cc))
* **tipos:** os 25 arquivos que so tinham parametro sem tipo saem da catraca ([7cc8bff](https://github.com/nipscernlab/aurora/commit/7cc8bff513e5d534348a16915adcf3019bb3f74a))
* **tipos:** os botoes de recolher e de backup da arvore viram .ts, e leem o projeto do ProjectStore ([2eedb60](https://github.com/nipscernlab/aurora/commit/2eedb60c48099b5ba0d7bc00faad2f026eb20fe1))
* **tipos:** os canais de componentes viram .ts em strict ([fd0b7d7](https://github.com/nipscernlab/aurora/commit/fd0b7d780104743dc0433fc719109ee28de592ec))
* **tipos:** preview vira .ts em strict ([6bdc5fc](https://github.com/nipscernlab/aurora/commit/6bdc5fcd3d79b102e7444852b1c8d970b6e0a029))
* **tipos:** prism_vcd vira .ts em strict ([56b081b](https://github.com/nipscernlab/aurora/commit/56b081b5eaecba83fe50a47c5689d5647a6e9724))
* **tipos:** process_registry vira .ts, e o spawnTracked diz quando os pipes existem ([6764335](https://github.com/nipscernlab/aurora/commit/67643353556550b1410b858e41e6f2300f9bb267))
* **tipos:** processor_compiler vira .ts em strict, com as fronteiras dele declaradas ([3b8f8ff](https://github.com/nipscernlab/aurora/commit/3b8f8ffe930a8008e51c72f70799d06d707d868f))
* **tipos:** processor_hub vira .ts em strict ([f03f048](https://github.com/nipscernlab/aurora/commit/f03f04858f9d216cb764d9ff42cb3a9b805d320b))
* **tipos:** project_paths vira .ts em strict ([8b6ee93](https://github.com/nipscernlab/aurora/commit/8b6ee9373591a1283d3b709367045080068f3dea))
* **tipos:** project_store vira .ts em strict, pelo conversor ([722446b](https://github.com/nipscernlab/aurora/commit/722446b65a967ea4d8296ad0f711b2681c558940))
* **tipos:** project_temp, api_reply e verilog_stats viram .ts, e os tres .d.ts escritos a mao somem ([f1808d3](https://github.com/nipscernlab/aurora/commit/f1808d3d5cccbba75d5c36d3e02beb2a38c23bd1))
* **tipos:** protected_flags vira .ts em strict, e ganha o teste que nao tinha ([119aa68](https://github.com/nipscernlab/aurora/commit/119aa6812a372dace07fa0fd801ccc55f5601b53))
* **tipos:** provider da IA vira .ts em strict ([226325b](https://github.com/nipscernlab/aurora/commit/226325ba7c1e349065964754291fe4238df81fe4))
* **tipos:** pylib_manager vira .ts em strict, e a catraca cai de 99 para 62 ([f5e169a](https://github.com/nipscernlab/aurora/commit/f5e169ab9b3991bc0222665f6914899ba3319164))
* **tipos:** run_history vira .ts em strict, pelo conversor ([2e5e622](https://github.com/nipscernlab/aurora/commit/2e5e6224bf493b89c1da322a10178464d14c7a28))
* **tipos:** run_log do main vira .ts em strict ([6db643d](https://github.com/nipscernlab/aurora/commit/6db643dfebab409c5ebc2aabf46aec1ac90142a0))
* **tipos:** run_log, problem_store e as preferencias de onda viram .ts em strict, pelo conversor ([88c6215](https://github.com/nipscernlab/aurora/commit/88c62158cec757d74eb69644eb28ff1006695b7a))
* **tipos:** slang_lsp vira .ts em strict, pelo conversor ([dcd8f9c](https://github.com/nipscernlab/aurora/commit/dcd8f9cd201a6e739d075b6d51fa74b0f13ba0ca))
* **tipos:** tab_utils vira .ts em strict ([3d9847f](https://github.com/nipscernlab/aurora/commit/3d9847f528dff61015d566dd0c42d12fd1b87cba))
* **tipos:** verible_lsp vira .ts em strict, pelo conversor automatico ([2c68cef](https://github.com/nipscernlab/aurora/commit/2c68cefde269baa71379761020a21396676268f4))
* **tipos:** wave_toolchain, gtkw_custom e a preferencia de janelas do Surfer viram .ts em strict, pelo conversor ([c6ca082](https://github.com/nipscernlab/aurora/commit/c6ca0823ae891b54c9c9d80169208ba6cf31d238))


### Documentation

* **contributing:** arquivo grande tambem e convertido inteiro para TypeScript ([84a59ff](https://github.com/nipscernlab/aurora/commit/84a59ff82ae2ee680c86a66bdc74015af9d0a6ec))
* **contributing:** o que o mantenedor precisa saber de release, token e assinatura ([cb8c271](https://github.com/nipscernlab/aurora/commit/cb8c271ad2e5a6c91a9b242712eb2673108a6ecc))
* **contributing:** toda mudanca sai em TypeScript e com as linhas tocadas cobertas por teste ([f44345c](https://github.com/nipscernlab/aurora/commit/f44345c553d7070532032420d14b0b551acd63c7))
* **github-auth:** o OAuth App do login de um clique agora e da organizacao ([33e85ed](https://github.com/nipscernlab/aurora/commit/33e85ed300f774623957b8dfde9ee18e84ce813a))
* **referencia:** a referencia tecnica passa a descrever o ISA e o HDL do yanc v5.5 ([a0598c6](https://github.com/nipscernlab/aurora/commit/a0598c63298f714116aab3e4689d3ad44ce28f02))
* TODO secao 7 e ARCHITECTURE secao 13 registram a Fase 1 do C++ e o lugar unico do fonte ([7ded6cf](https://github.com/nipscernlab/aurora/commit/7ded6cf4e8d15ad2ae17d10f165df23803f3bab4))
* **todo:** a Fase 2 do C++ passa a dizer o que ja saiu ([8ac0c73](https://github.com/nipscernlab/aurora/commit/8ac0c730d228d82657d7096beeb13ecca4072529))
* **todo:** a ordem do 13.2 e do 13.3 muda para gigante por gigante, e o compilation_flow saiu ([a1f45a4](https://github.com/nipscernlab/aurora/commit/a1f45a43da7072ed3d7ddbeb6436fd3bf3e0828d))
* **todo:** a passagem da manutencao e o fim da transicao entram na secao 11 ([6b01471](https://github.com/nipscernlab/aurora/commit/6b01471eb1f8bddbfb5e7621b2e914a0c6e36d23))
* **todo:** andamento do 13.2, o que ja le do ProjectStore e o que falta ([0ba607a](https://github.com/nipscernlab/aurora/commit/0ba607a1a68870146c2dbce0c3376a7be25e5c54))
* **todo:** as pendencias abertas nesta sessao entram na lista, e o estado sai de agosto ([925a7f5](https://github.com/nipscernlab/aurora/commit/925a7f535385e76a3e3720c13c4a98ee6eab547c))
* **todo:** estado do 13.2 e 13.3 em 26/09 ([1b2e3b3](https://github.com/nipscernlab/aurora/commit/1b2e3b30b899e5dbfd5370332f08aafac719b632))
* **todo:** estado do 13.2 no fim da sessao de 25/09 ([182c92b](https://github.com/nipscernlab/aurora/commit/182c92ba566a7dbe6bc5339a1fc40975c4d11475))
* **todo:** o 13.2 com 9 leituras restantes, a arvore convertida e o fim do ciclo de import ([aa05930](https://github.com/nipscernlab/aurora/commit/aa059308b8e8d4db127df7fc499435f90cf85123))
* **todo:** o Arthur ja e dono da organizacao nipscernlab ([57b46ca](https://github.com/nipscernlab/aurora/commit/57b46cabd9e06beea5cd130611658fbb6c49dd14))
* **todo:** o aurora_api dividido, os dois defeitos de envelope e o E2E instavel ([96de2dd](https://github.com/nipscernlab/aurora/commit/96de2dd54c85a0371b38caa5c4eeea7f990c8595))
* **todo:** o certificado de producao da SignPath esta em CSR PENDING ([1426604](https://github.com/nipscernlab/aurora/commit/14266045ce446f96376108ebf9a57620fbb062ca))
* **todo:** o painel de IA le o projeto do store; sobra a leitura do renderer.js ([7afeb09](https://github.com/nipscernlab/aurora/commit/7afeb0910a1ba19486be705cfc85b67ab389ef4b))
* **todo:** o plano de desmacarronar e o que falta da migracao para TypeScript ([869fd0b](https://github.com/nipscernlab/aurora/commit/869fd0b785705536f2f0f221b2167a13de98eb45))
* **todo:** o que saiu do painel de IA em 26/09 ([a580d69](https://github.com/nipscernlab/aurora/commit/a580d69d1e7c11b43c7c313dc90faf4fec4b295f))
* **todo:** terminal_module dividido e js/terminal sem .js ([73abac8](https://github.com/nipscernlab/aurora/commit/73abac8a37d0a90ff20860cda70879fb6ccb328b))


### Build

* o conversor de .js para .ts entra no repositorio, com a dependencia typescript-5 ([ccca1a4](https://github.com/nipscernlab/aurora/commit/ccca1a496d76c5d7688e1e8951f78dd7669e02b7))
* **ts:** tsconfig.main.json emite CommonJS para o main/, e binary_allowlist e o primeiro .ts de la ([e4cf100](https://github.com/nipscernlab/aurora/commit/e4cf100c17a891f5696de1358a82bdd444c97157))
...
* **dev:** feed de atualizacao local, para testar o card sem publicar release ([f993846](https://github.com/nipscernlab/aurora/commit/f99384669b3ffa74dbe676b39ac1af4878ba6219))
...
* **dev:** o feed local serve tambem o .blockmap, quando houver ([e1c0711](https://github.com/nipscernlab/aurora/commit/e1c0711412d3b09d9a0ff557984106b96e4607bf))
...
* a 6.11.1 sai so para o instalador trazer o manual 6.11.0.5 ([ae983e7](https://github.com/nipscernlab/aurora/commit/ae983e762860d184fc45bce28d0c6ede3da8419f))
...
* licenca do instalador em texto puro, limpeza do GitHub, e menos travessoes ([73b49d8](https://github.com/nipscernlab/aurora/commit/73b49d89dfccba73cedb33260e1e9944b73460a0))
* oito ajustes pedidos em 09/08/2026 ([5fd85b3](https://github.com/nipscernlab/aurora/commit/5fd85b337ce53159113fe6c1d65ebe373a0d3028))
