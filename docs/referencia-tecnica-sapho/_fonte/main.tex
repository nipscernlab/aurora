...
% --------------------------- CAPÍTULOS ---------------------------
\input{capitulos/01-contexto-visao-geral}
\input{capitulos/02-arquitetura-soft-processor-sapho}
\input{capitulos/03-linguagem-cmm}
\input{capitulos/04-yanc-compiladores}
\input{capitulos/05-aurora-arquitetura}
\input{capitulos/06-aurora-editor}
\input{capitulos/07-aurora-projeto-arvore}
\input{capitulos/08-aurora-compilacao}
\input{capitulos/09-aurora-simulacao-ondas}
\input{capitulos/10-aurora-visualizacao-gtkwave-surfer}
\input{capitulos/11-aurora-prism-rtl}
\input{capitulos/12-aurora-intelligence-ia}
\input{capitulos/13-aurora-produtividade}
\input{capitulos/14-toolchain-bundle}
\input{capitulos/15-catalogo-terceiros}
\input{capitulos/16-build-distribuicao}
\input{capitulos/17-pipeline-ponta-a-ponta}
\input{capitulos/18-engenharia-evolucao}

% --------------------------- APÊNDICES ---------------------------
\appendix
\input{apendices/glossario}
\input{apendices/referencias}
