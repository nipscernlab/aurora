...
proprio do laboratorio: o \emph{provider} e os modelos treinados pelo NIPS-CERN
...
gramatica do compilador YANC, de exemplos reais de \cmm{}, do site do NIPS-CERN e
...
\begin{nota}
\textbf{Item de roteiro --- modelo proprio do NIPS-CERN.} O \emph{provider} e os
