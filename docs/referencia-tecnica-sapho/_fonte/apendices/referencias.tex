...
\file{README.md}, \file{ARCHITECTURE.md}, \file{CHANGELOG.md}, \file{CONTRIBUTING.md},
\file{THIRD_PARTY_NOTICES.md}, \file{CITATION.cff}, \file{TODO.md} (o único registro de pendências,
que também guarda as decisões de projeto) e os documentos em \file{docs/}, entre eles
\file{docs/aurora-intelligence-tools.md}, o manual do usuário em \file{docs/manual-sapho/} e este
próprio relatório em \file{docs/referencia-tecnica-sapho/}.
