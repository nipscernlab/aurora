/**
 * verilog_classifier.js — heuristica synth-vs-testbench.
 *
 ...
 */
function hasPortlessModule(code) {
 ...
 *
 * @param {string} content   conteudo bruto do arquivo
 * @param {string} fileName  nome do arquivo (so pro hint de nome)
 * @returns {'testbench'|'synthesizable'}
 */
export function classifyVerilogContent(content, fileName = '') {
