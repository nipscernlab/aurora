...
\subsection{Nosso fork (NIPS-CERN)}
\begin{itemize}
...
O Surfer-Aurora é um fork do Surfer mantido pela NIPS-CERN, em
...
(a base) mais uma revisão da NIPS-CERN, por exemplo \texttt{v0.7.0-nips.2},
...
\begin{itemize}
  ...
  \item SHA-256:
        \texttt{\seqsplit{a27dac113e0b74b2bcc6ec477beab040102ad1889720b7d8b15047cd37efa8ba}}
...
\begin{itemize}
  \item \texttt{js/compilation/wave\_toolchain.js} resolve o caminho
        \nolinkurl{components/Packages/surfer/surfer-aurora.exe}.
