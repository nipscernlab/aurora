...
**Radical (8–10):**
- [~] **A2** decompor god-files (ai_assistant 4515 · compilation 4197 · tab_manager 2044) — EM ANDAMENTO. compilation_module: **4/5 extrações FEITAS** 19/06/2026 (#1 hierarchy_parser +11 testes `eb14e3f`; #2 hierarchy_view `4eecdf7`; #3 wave_toolchain +16 testes `e03c07e`; #4 wave_signal_validator +13 testes, deps bag + delegadores, seam do _validatedWaveSelection preservado, revisão adversarial 0 defeitos; −739 linhas, 4197→3458). Restante: #5 processor_compiler + os god-files ai_assistant/tab_manager. Plano detalhado em §14.42.
